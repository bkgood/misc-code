...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LineItem.income'
        db.add_column('afap_lineitem', 'income', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LineItem.income'
        db.delete_column('afap_lineitem', 'income')

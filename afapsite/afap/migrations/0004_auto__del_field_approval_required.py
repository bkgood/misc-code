...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Approval.required'
        db.delete_column('afap_approval', 'required')


    def backwards(self, orm):
        
        # Adding field 'Approval.required'
        db.add_column('afap_approval', 'required', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Application.balance_forward'
        db.add_column('afap_application', 'balance_forward', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Application.afap_income'
        db.add_column('afap_application', 'afap_income', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Application.balance_forward'
        db.delete_column('afap_application', 'balance_forward')

        # Deleting field 'Application.afap_income'
        db.delete_column('afap_application', 'afap_income')
    ...
    models = {
        'afap.application': {
            ...
            'afap_income': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'balance_forward': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'dues': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '10', 'decimal_places': '2'}),
            'email_advisor': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

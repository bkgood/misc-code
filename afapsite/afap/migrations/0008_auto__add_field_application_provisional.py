...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Application.provisional'
        db.add_column('afap_application', 'provisional', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Application.provisional'
        db.delete_column('afap_application', 'provisional')

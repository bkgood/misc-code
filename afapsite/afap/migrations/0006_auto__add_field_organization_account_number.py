...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('afap_organization', 'account_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.account_number'
        db.delete_column('afap_organization', 'account_number')

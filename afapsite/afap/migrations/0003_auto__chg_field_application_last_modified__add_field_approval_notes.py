...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.last_modified'
        db.alter_column('afap_application', 'last_modified', self.gf('django.db.models.fields.DateTimeField')())

        # Adding field 'Approval.notes'
        db.add_column('afap_approval', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Application.last_modified'
        db.alter_column('afap_application', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Deleting field 'Approval.notes'
        db.delete_column('afap_approval', 'notes')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('afap_applicationfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['afap.Application'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('replaces_application', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('afap', ['ApplicationFile'])


    def backwards(self, orm):
        
        # Deleting model 'ApplicationFile'
        db.delete_table('afap_applicationfile')
    ...
    models = {
        ...
        'afap.applicationfile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'replaces_application': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'afap.approval': {

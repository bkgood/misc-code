...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Allocation.notified'
        db.add_column('afap_allocation', 'notified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Allocation.notified'
        db.delete_column('afap_allocation', 'notified')
